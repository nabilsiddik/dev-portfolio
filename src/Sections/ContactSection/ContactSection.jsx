                    ...
                    <div className="contact-form w-full md:w-6/12">
                        <form>
                            <div className="input-gorup">
                                <div className='flex items-center gap-5'>
                                    <div className='w-6/12'>
                                        <label className='label text-primary mb-1 text-md' htmlFor="first name">First Name</label>
                                        <input type="text" className='input input-bordered py-6 border border-primary' placeholder='First Name' />
                                    </div>

                                    <div className='w-6/12'>
                                        <label className='label text-primary mb-1 text-md' htmlFor="first name">Last Name</label>
                            ...
                            <div className='flex items-center gap-5 mt-7'>
                                <div className='w-6/12'>
                                    <label className='label text-primary mb-1 text-md' htmlFor="email">Email</label>
                                    <input type="email" className='input input-bordered py-6 border border-primary' placeholder='Your Email' />
                                </div>

                                <div className='w-6/12'>
                                    <label className='label text-primary mb-1 text-md' htmlFor="first name">Phone / Whatsapp</label>
                            ...
                            <div className="input-group mt-7">
                                <label className='label block text-primary mb-1 text-md' htmlFor="first name">Subject</label>
                                <input type="text" className='input input-bordered py-6 border border-primary w-full' placeholder='Your Phone / Whatsapp' />
                            </div>

                            <div className='mt-7'>
                                <label className='label block text-primary mb-1 text-md' htmlFor="first name">Message</label>
